...
description: "The sub-processors Taxy engages to provide app.taxy.au, the customer data each processes, and their locations."
...
[Data Processing Agreement](/legal/dpa/). We give customers at least 30 days' notice
of any change to this list, as set out in the DPA.

| Sub-processor | Purpose | Customer data processed | Location |
|---|---|---|---|
| **Google Cloud Platform** (Google LLC) | Cloud hosting and storage for app.taxy.au | All Customer Content | Australia (primary); United States (backups) |
...
All Taxy sub-processors are SOC 2 and/or ISO 27001 evidenced.
